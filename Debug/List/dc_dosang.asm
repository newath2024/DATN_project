...
; 0000 0047 // Function: Bit7=In Bit6=In Bit5=In Bit4=Out Bit3=In Bit2=In Bit1=In Bit0=In
; 0000 0048 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(16)
	OUT  0x11,R30
; 0000 0049 // State: Bit7=T Bit6=T Bit5=T Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
...
; 0000 0057 // Clock value: 1000.000 kHz       8.000.000 hz (tan so thach anh)      TCNT tang len 1 thi ? chu ky 1us  1000 cau lenh  ...
; 0000 0058                                                                                                           //  1          ...
; 0000 0059 // Mode: Fast PWM top=ICR1
; 0000 005A // OC1A output: Disconnected
; 0000 005B // OC1B output: Inverted PWM
; 0000 005C // Noise Canceler: Off
; 0000 005D // Input Capture on Falling Edge
; 0000 005E // Timer Period: 1 us
; 0000 005F // Output Pulse(s):
; 0000 0060 // OC1B Period: 1 us
...
; 0000 0065 TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (1<<COM1B1) | (1<<COM1B0) | (1<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(50)
	OUT  0x2F,R30
...
; 0000 0068 TCNT1L=0x00;
	OUT  0x2C,R30
; 0000 0069 // ICR => chu ky ,
; 0000 006A ICR1H=0x01;   // 2kh =>  icr=500
	LDI  R30,LOW(1)
	OUT  0x27,R30
; 0000 006B ICR1L=0xF4;
	LDI  R30,LOW(244)
	OUT  0x26,R30
; 0000 006C 
...
; 0000 0073 
; 0000 0074 
; 0000 0075     //   ICR=? de tan so xung la` 1khz
...
; 0000 00A4 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 00A5   //=> OCR1B thay doi duty
; 0000 00A6           OCR1BH=0x00;
	OUT  0x29,R30
; 0000 00A7      OCR1BL=250;
	LDI  R30,LOW(250)
	OUT  0x28,R30
; 0000 00A8 
; 0000 00A9 while (1)
